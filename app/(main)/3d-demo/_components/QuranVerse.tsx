...
export default function QuranVerse({ scrollY }: QuranVerseProps) {
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center p-15 pointer-events-none"
      ...
      <div className="relative w-full max-w-2xl min-w-[300px]">
        <div className="relative bg-white/80 backdrop-blur-lg rounded-2xl p-8 md:p-12 text-center space-y-6 shadow-2xl border border-white/30">
          ...
          <div className="relative z-10">
            <div className="font-amiri text-2xl md:text-5xl text-amber-800 text-center leading-tight mb-6 tracking-wide">
              بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ
            </div>
            <div className="w-24 h-0.5 bg-amber-300/70 mx-auto mb-8 rounded-full"></div>
            <div className="text-xl md:text-3xl font-arabic text-amber-900 leading-loose mb-6">
              وَمِنْ آيَاتِهِ أَنْ خَلَقَ لَكُم مِّنْ أَنفُسِكُمْ أَزْوَاجًا لِّتَسْكُنُوا إِلَيْهَا وَجَعَلَ بَيْنَكُم مَّوَدَّةً وَرَحْمَةً ۚ إِنَّ فِي ذَٰلِكَ لَآيَاتٍ لِّقَوْمٍ يَتَفَكَّرُونَ
            </div>
            <div className="text-xs md:text-sm text-amber-800/80 italic mb-6">
